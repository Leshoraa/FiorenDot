...
Singleton {
    ...
    animationCurves: QtObject {
        readonly property list<real> expressiveDefaultSpatial: [0.10, 0.90, 0.20, 1.00, 1, 1]
        readonly property list<real> expressiveEffects: [0.10, 0.90, 0.20, 1.00, 1, 1]
        readonly property list<real> emphasizedDecel: [0.05, 0.90, 0.10, 1.00, 1, 1]
        readonly property real expressiveDefaultSpatialDuration: 160
        readonly property real expressiveEffectsDuration: 100
    }
